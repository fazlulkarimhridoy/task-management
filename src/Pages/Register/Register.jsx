  ...
  return (
    <section className="bg-white">
      ...
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        ...
        <main className="flex items-center justify-center px-8 sm:px-12 lg:col-span-7 lg:px-16 lg:pb-16 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl">
            ...
            >
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                <input
                  {...register("lstName", { required: true })}
                  type="text"
                  className="mt-1 w-full rounded-md border p-2 border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
                />
                {errors.name && (
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                {errors.password?.type === "maxLength" && (
                  <span className="text-red-600">
                    Password should be maximum 20 character
                  </span>
                )}
                {errors.password?.type === "pattern" && (
                  <span className="text-red-600">
                    Password should have one uppercase, one lowercase , one
                    numeric value & one special character
                  </span>
                )}
              </div>
